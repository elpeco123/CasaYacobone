...
<div class="fade-in">
    <div class="page-header">
        <h1><i class="bi bi-pencil-fill me-2" style="color: var(--cy-gold);"></i>Editar Categoría de Gasto</h1>
    </div>
        ...
        <div class="col-lg-5">
            <div class="card-glass">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('categoria-gastos.update', $categoria) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('categoria-gastos.index') }}" class="btn btn-glass">
